...
function setup() {
  ...
  //creates the canvas that will be drawn
  // createCanvas(windowWidth, 1500);

// right now the canvas is being drawn at half of the window size 
  createCanvas(windowWidth, windowHeight);

//create a new div with center positioning
...
// here the text is being styled and added to the canvas
...
let s = str(dbmessage);
// fill(255,255,255);
// rect(windowWidth/3-200, 50, 400, 1050,10);
textSize(50);
textFont('lores-12, sans-serif');
// textStyle(BOLD);
// fill(255,255,255);
// text(s, windowWidth/3-150, 100, 300, 1000);

// text(s,10, 10, windowWidth-50, windowHeight-50);
fill(255, 255, 255, 70);
text(s,10, 10, windowWidth-50, windowHeight-50);
...
// CONDENSED, WORKING DRAW FUNCTION
// function draw() {
// input.hide();
// button.hide();
// //background color
...
function pullContent() {
  ...
  for(var i=0; i<elements.length; i++){
    if (elements[i].className == 'affect_link') { 
